...
<!--                <div class="form-control text-danger" v-if="props.data?.discount?.additional_discount_percent"><b-->
<!--                    class="text-dark">Установлен:</b> Скидка-->
<!--                  -{{ props.data?.discount?.additional_discount_percent }}%-->
<!--                </div>-->
<!--                <div class="form-control" v-else>Не установлена</div>-->
<!--              </div>-->
<!--            </div>-->
<!--          </li>-->
          <li class="list-group-item d-flex justify-content-between"
...
defineComponent({name: 'OrderDetailConfirmOrderInfo'})
</script>
