<template>
  <BaseModal title="Добавить ваешалку" id="create-hanger">
    <template #content>
    ...
    <template #footer>
      <button type="button" class="btn btn-sm btn-success me-1" @click.prevent="submit">
        Сохранить
      </button>
...
const submit = async () => {
  ...
  try {
    await storeHanger.createHanger(state)
