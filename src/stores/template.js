...
export const useTemplateStore = defineStore({
  ...
  state: () => ({
    // App vital details
    app: {
      name: "Admin Panel by Viento",
      version: "1.0.0",
      copyright: new Date().getFullYear(),
    },
    toast: {
      iconClass: 'fa fa-check-circle text-success',
      title: 'Ура все прошо успешно',
      subTitle: 'Все прошло гладко без каких либо проблем!',
    },
    toastError: {
      iconClass: 'fa fa-times text-danger',
      title: 'Что то посло явно не так',
      subTitle: 'При попытки обработки ваших данных произошла ошибка',
    },
